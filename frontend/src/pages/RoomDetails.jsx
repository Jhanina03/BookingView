  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
        ...
        <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                ...
                <div className='flex flex-col'>
                    ...
                    <input type="number" id='checkOutDate' min={1} placeholder='1'
                    className='max-w-20 rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required/>
                </div>
            </div>
            <button type='submit' className='bg-primary hover:bg-primary/90
            hover:animate-scale active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:mt-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>Book Now</button>
        </form>
        ...
        <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
            <p>Room description... Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto, in alias molestiae impedit aliquam vel doloribus, esse culpa dolorem totam, doloremque dolor cumque? Eveniet saepe iste, ducimus asperiores vitae quisquam.</p>
        </div>
