...
const AddRoom = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    //Converting Amenities to Array & keeping only true values
    ...
    <form onSubmit={onSubmitHandler} >
      ...
      <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4 '>
        ...
        <div>
          ...
          <input type="number" placeholder='0' className='border border-gray-300 mt-1 rounded p-2 w-24' value={inputs.pricePerNight} onChange={(e) => setInputs({ ...inputs, pricePerNight: e.target.value })} min={0} />
        </div>
      </div>
      <p className='text-gray-800 mt-4'>Amenities</p>
      <div className='flex flex-col flex-wrap mt-1 text-gray-400 mx-w-sm'>
