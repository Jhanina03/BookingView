...
const ListRoom = () => {
  ...
  //Feching rooms listed by the owner
    ...
    const fecthRooms = async () => { 
      ...
      //Toogle Availability of the rrom
      ...
      <div className='w-full max-w-3xl text-left border border-gray-300 rounded-lg max-h-80 overflow-y-scroll mt-3'>
        <table className='w-full'>
          <thead className='bg-gray-50'>
            <tr>
              <th className='py-3 px-4 text-gray- font-medium'>Name</th>
              <th className='py-3 px-4 text-gray- font-medium max-sm:hidden'>Facility</th>
              <th className='py-3 px-4 text-gray- font-medium'>Price / night</th>
              <th className='py-3 px-4 text-gray- font-medium text-center'>Actions</th>
            </tr>
          </thead>
